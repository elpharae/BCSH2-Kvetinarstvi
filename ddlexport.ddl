...
ALTER TABLE ceny
    ADD CONSTRAINT ceny_kvetiny_fk FOREIGN KEY ( kvetina_id )
...
ALTER TABLE objednane_kvetiny
    ADD CONSTRAINT objkv_kvetina_fk FOREIGN KEY ( kvetina_id )
        REFERENCES kvetiny ( kvetina_id );

ALTER TABLE objednane_kvetiny
    ADD CONSTRAINT objkv_objednavka_fk FOREIGN KEY ( objednavka_id )
